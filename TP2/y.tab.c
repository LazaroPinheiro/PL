...
#define CONCEITO 258
#define TITULO 259
#define SUBTITULO 260
#define CONTEUDO 261
#define PARAGRAFO 262
#define SUJEITO 263
#define RELACAO 264
#define OBJECTO 265
...
{
       0,     0,     3,     6,     7,    10,    14,    18,    19,    22,
      25,    27,    29,    33,    34,    38,    41,    44
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      12,     0,    -1,    12,    13,    -1,    -1,    14,    17,    -1,
       3,     4,    15,    -1,    15,     5,    16,    -1,    -1,    16,
       6,    -1,    16,     7,    -1,     6,    -1,     7,    -1,    17,
       8,    18,    -1,    -1,    18,     9,    19,    -1,     9,    19,
      -1,    19,    10,    -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "CONCEITO", "TITULO", "SUBTITULO",
  "CONTEUDO", "PARAGRAFO", "SUJEITO", "RELACAO", "OBJECTO", "$accept",
  "caderno", "par", "documento", "topicos", "texto", "triplos", "relacoes",
  "objectos", 0
};
#endif
...
{
       3,     0,     1,     0,     2,    13,     7,     4,     5,     0,
       0,     0,    12,    10,    11,     6,    17,    15,     0,     8,
       9,    16,    14
};
...
{
     -10,     0,   -10,     2,   -10,   -10,   -10,    -1,     3,     1,
      -5,     4,     6,   -10,   -10,    -2,   -10,     7,     4,   -10,
     -10,   -10,     7
};
...
{
       2,    13,    14,     3,    19,    20,     6,     9,    10,    22,
      11,     0,     0,     0,    16,    18,     0,    21
};

static const yytype_int8 yycheck[] =
{
       0,     6,     7,     3,     6,     7,     4,     8,     5,    18,
       9,    -1,    -1,    -1,    10,     9,    -1,    10
};
...
{
       0,    12,     0,     3,    13,    14,     4,    17,    15,     8,
       5,     9,    18,     6,     7,    16,    10,    19,     9,     6,
       7,    10,    19
};
  ...
  switch (yyn)
    {
        case 5:
#line 35 "DSL.y"
    { generateConceito((yyvsp[(1) - (3)].string), (yyvsp[(2) - (3)].string)); }
    break;
...
#line 42 "DSL.y"
  ...
  case 9:
#line 43 "DSL.y"
    { printf("%s\n", (yyvsp[(2) - (2)].string)); printf("Paragrafo\n"); }
    break;
...
#line 44 "DSL.y"
  ...
  case 11:
#line 45 "DSL.y"
    { printf("%s\n", (yyvsp[(1) - (1)].string)); printf("Paragrafo\n"); }
    break;
